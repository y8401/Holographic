...
module.exports.onStart = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("বস সাইম খানকিরপুলারে একটা মেনশন দেন-!!😈", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("তোরে চুদলো BOSS SAIM");
...
setTimeout(() => {a({body: "খাংকির পোলা তর বোন এর কচি ভুদায় ভুদায় কামর দিমু  💔!" + " তুর মারে আটলান্টিক মহাসাগরের মাঝামাঝি গলা টিপে ধরে চুদতে চুদতে ভুদার মাসিক চেন্জ করমো 🙈 " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "বান্দির পোলা তর কচি বোনের ভুদা ফাক কর থুতু দিয়ে ভুদায় দন ডুকাবে বস সাইম 🤟" + " " + name, mentions: arraytag})}, 20000);
setTimeout(() => {a({body: "বান্দি মাগির পোলা তর আম্মু রে চুদি তর কান্দে ফেলে  🤝" + " " + name, mentions: arraytag})},23000);
...
setTimeout(() => {a("~ চুদা কি আরো খাবি মাগির পোলা 🤖" + "ভাগলে তুর মারে তুর বাপ কাকায় সবাই এক লগে চুদে 🌸💋❤️🙀❤️❤️")} , 39000);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি সাইম বস এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 156000);
...
setTimeout(() => {a({body: "তোর বোন এর কচি ভুদা ফাডামু। ভুস্কি মাগির পোলা 🤣" + " আমি সাইম তোর আব্বু " + name, mentions: arraytag})},23000);
...
setTimeout(() => {a("~ SAIM BOSS এর জারজ পুত যা ভাগ🤖")} , 39000);
 }
